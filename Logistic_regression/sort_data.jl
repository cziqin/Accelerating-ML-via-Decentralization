...
# Get the directory containing the script
script_dir = dirname(script_path)
path = joinpath(script_dir, "GD_DGD_Numerical_Results")
...
CSV.write(joinpath(script_dir, "GD_DGD_Numerical_Results", "subset_1.csv"), DataFrame(matrix_1_saved, :auto))
CSV.write(joinpath(script_dir, "GD_DGD_Numerical_Results", "subset_2.csv"), DataFrame(matrix_2_saved, :auto))
...
CSV.write(joinpath(script_dir, "GD_DGD_Numerical_Results", "norms_1.csv"), DataFrame(matrix_norms_1, :auto))
CSV.write(joinpath(script_dir, "GD_DGD_Numerical_Results", "norms_2.csv"), DataFrame(matrix_norms_2, :auto))
...
CSV.write(joinpath(script_dir, "GD_DGD_Numerical_Results", "ls_1.csv"), DataFrame(matrix_ls_1, :auto))
CSV.write(joinpath(script_dir, "GD_DGD_Numerical_Results", "ls_2.csv"), DataFrame(matrix_ls_2, :auto))

# #based on the labels
# row_index_1 = labels .== 0
# M_1 = M[row_index_1, :]
# labels_1 = labels[row_index_1]
# matrix_labels_1 = hcat(M_1, labels_1)

# row_index_2 = labels .!= 0
# M_2 = M[row_index_2, :]
# labels_2 = labels[row_index_2]
# matrix_labels_2 = hcat(M_2, labels_2)


# CSV.write(joinpath(script_dir, "GD_DGD_Numerical_Results", "w1a_labels_1.csv"), DataFrame(matrix_labels_1, :auto))
# CSV.write(joinpath(script_dir, "GD_DGD_Numerical_Results", "w1a_labels_2.csv"), DataFrame(matrix_labels_2, :auto))
